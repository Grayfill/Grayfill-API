...
```bash
curl -X POST "https://api.grayfill.xyz/v1/swap/execute" \
...
```bash
curl "https://api.grayfill.xyz/v1/swap/history/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU?limit=10&offset=0"
```
