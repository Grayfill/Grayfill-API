...
```bash
curl "https://api.grayfill.xyz/v1/tokens?verified=true&limit=50"
```
...
```bash
curl "https://api.grayfill.xyz/v1/tokens/So11111111111111111111111111111111111111112"
```
...
```bash
curl "https://api.grayfill.xyz/v1/tokens/trending?limit=10&timeframe=24h"
```
...
```bash
curl "https://api.grayfill.xyz/v1/tokens/search?q=sol&limit=10"
```
