# Grayfill Exchange API Documentation
...
```bash
curl https://api.grayfill.xyz/v1/tokens
```
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://api.grayfill.xyz/v1/tokens
```
...
```bash
curl "https://api.grayfill.xyz/v1/swap/quote?inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=1000000000&slippageBps=50"
```
...
```bash
curl "https://api.grayfill.xyz/v1/price?ids=So11111111111111111111111111111111111111112,EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
```
...
- **Website:** [https://grayfill.xyz](https://grayfill.xyz)
- **GitHub:** [https://github.com/Grayfill/Grayfill-API](https://github.com/Grayfill/Grayfill-API)
- **Twitter:** [https://x.com/GrayfillSwap](https://x.com/GrayfillSwap)

## Support

For support, questions, or feature requests:

- Open an issue on [GitHub](https://github.com/Grayfill/Grayfill-API)
- Follow us on [Twitter](https://x.com/GrayfillSwap)
- Visit our website at [grayfill.xyz](https://grayfill.xyz)
