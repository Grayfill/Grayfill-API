...
```bash
curl "https://api.grayfill.xyz/v1/wallet/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU/balance"
```
...
```bash
curl "https://api.grayfill.xyz/v1/wallet/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU/tokens?verifiedOnly=true"
```
...
```bash
curl "https://api.grayfill.xyz/v1/wallet/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU/activity?limit=10&type=swap"
```
...
```bash
curl "https://api.grayfill.xyz/v1/wallet/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU/portfolio?timeframe=7d"
```
...
```bash
curl "https://api.grayfill.xyz/v1/wallet/7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU/nfts?limit=20"
```
